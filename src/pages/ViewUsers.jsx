        ...
        <div className="relative w-[50%] mx-auto mt-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 rounded-xl">
          <div className="flex flex-row">
            <div className="w-[35%] h-[100%]">
              <div className="bg-gray-800 border border-gray-100 rounded-lg text-center hover:shadow-lg align-center">
                <div
            ...
            <div className="w-[65%]">
              <div className="h-[40%] ">
                ...
                <div className="pt-6 mx-6 text-center border-t border-gray-200 dark:border-gray-700/50">
                <div className="w-full flex flex-row mx-auto justify-end space-x-12 mr-32">
                  <FaPen className="text-indigo-500 cursor-pointer" title="Edit" onClick={penClicked} /> 
                  <FaTrash className="text-rose-500 cursor-pointer" title="Delete" onClick={trashClicked}/>
                </div>
                ...
                <div className="w-full mb-5">
                  <div className="flex justify-center pt-8 pb-3 lg:pt-4">
                    <div className="flex space-x-[40px]">
                      <div className="flex-wrap flex space-x-16">
                        <a
